...
RSpec.configure do |c|
  ...
  c.before :suite do
    hosts.each do |host|
      ...
      on host, puppet('module install herculesteam-augeasproviders_sysctl --ignore-dependencies'), acceptable_exit_codes: [0]
      ...
      on host, puppet('module install puppetlabs-limits'), acceptable_exit_codes: [0]
      on host, puppet('module install puppetlabs-ntp'), acceptable_exit_codes: [0]
